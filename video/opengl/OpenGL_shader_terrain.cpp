...
OpenGLShaderTerrain::OpenGLShaderTerrain(){
	YY_DEBUG_PRINT_FUNC;
	m_program = 0;
	m_VAO = 0;
	m_uniform_WVP = 0;
...
bool OpenGLShaderTerrain::init(){
	...
	const char * text_v =
		...
		"texCoord.x = inputTexCoord.x * 50.0;\n"
		"texCoord.y = (1.f - inputTexCoord.y) * 50.0;\n"
	...
	const char * text_f =
		...
		"			    if(texel < viewPosition.z) lightPercent += 1.0;\n"
		"        }\n"
		"    }\n"
		"    lightPercent /= 4.f;\n"
