...
yyModel* CMainFrame::_importOBJ(const wchar_t* filePath, CString& outName)
{
	...
	/*  obj файл может быть оптимизированным, количество v vn vt может не совпадать.
		сначала читаю все v vn vt в эти массивы
	*/
	...
	/*  потом когда будет f придЄт врем€ создавать треугольники.
		индексы и вершины целой модели будут в этих массивах.	*/
	...
	// нужно дл€ случа€ если индексы указаны со знаком минус
	v4i last_counter;
	...
	while (*ptr)
	{
		...
		case 'f':
		{
			...
			// попробую переделать дл€ триангул€ции
			for (u32 sz2 = f.p.size() - 2, i2 = 0; i2 < sz2; ++i2)
			{
				...
				/*	¬ данном месте имеютс€ 3 вершины треугольника. Ќадо проверить, добавили ли ранее вершину с таки-ми же значени€ми.
					≈сли да, то берЄм индекс и суЄм его в индексный массив.
					≈сли нет, то суЄм вершину в массив с вершинами и добавл€ем новый индекс.								*/
