...
namespace Kr
{
	namespace Gui
	{
		struct NodeEditor
		{
			...
			bool(*callback)(NodeEditor* nodeEditor, callbackReason reason, NodeEditorNode* firstNode, NodeEditorNodeSocket* socket1, NodeEditorNode* secondNode, NodeEditorNodeSocket* socket2) ;
